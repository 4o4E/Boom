...
object Rain : ECommand(
    ...
    override val usage = """&a/bm rain &f切换当前世界天气在接下来的10分钟内为雨
    ...
    override fun onCommand(
        ...
        when (args.size) {
            1 -> {
                ...
                player.world.rain()
                plugin.sendMsgWithPrefix(sender, "&a已设置世界${player.world.name}在接下来的10分钟内天气为雨")
            }
            2 -> {
                ...
                world.rain()
                plugin.sendMsgWithPrefix(sender, "&a已设置世界${args[1]}在接下来的10分钟内天气为雨")
            }
            3 -> {
